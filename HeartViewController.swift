...
class HeartViewController: UIViewController, UIScrollViewDelegate {
...
//    @IBOutlet weak var pageControl: UIPageControl!
    ...
    func configureScrollView() {
        ...
        UIAccessibilityScrollDirection.Down
        ...
        for i in 0 ..< totalPages {
             ...
             let testView = NSBundle.mainBundle().loadNibNamed("Empty", owner: self, options: nil)[0] as! UIView
            ...
            let imgView = testView.viewWithTag(1) as! UIImageView
            imgView.image = UIImage(named: "\(i).png")
            // Add the test view as a subview to the scrollview.
            arr.append(UIImage(named: "\(i).png")!)
